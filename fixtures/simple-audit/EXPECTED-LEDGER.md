...
|---|---|---:|---|---|---|---|---|
| 1 | README collapses local commit and push authorization. | P1 | README.md derived from `skills/implementaudit/SKILL.md` | Restore separate-gate wording. | changed | Smoke B grep/manual inspection | - |
