...
| 2 | Adversarial auditor | `AUDIT_HANDOFF` can appear on success path. | P1 | `skills/templates/PROTOCOL.md`, `skills/SKILL.md`, `AGENTS.md` | Make handoff conditional and mutually exclusive with run completion. | changed | Marker readback and manual inspection | - |
