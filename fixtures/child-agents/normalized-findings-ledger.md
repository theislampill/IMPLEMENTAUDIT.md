...
|---|---|---:|---|---|---|---|---|---|
| 1 | Contract auditor | Planner markers missing from packaged references. | P1 | `skills/implementaudit/references/` and `scripts/verify-package.sh` | Add packaged reference coverage and validator checks. | changed | Smoke B package validation | - |
| 2 | Adversarial auditor | `AUDIT_HANDOFF` can appear on success path. | P1 | `skills/implementaudit/templates/PROTOCOL.md`, `skills/implementaudit/SKILL.md`, `AGENTS.md` | Make handoff conditional and mutually exclusive with run completion. | changed | Marker readback and manual inspection | - |
