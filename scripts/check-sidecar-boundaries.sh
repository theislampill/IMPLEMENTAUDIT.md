...
require_literal README.md "Ollama is explicitly unauthorized" "README backend summary"
require_literal README.md "smallest graph covering" "README scoped selection summary"
require_literal README.md "does not qualify semantic/Luna behaviour" "README semantic qualification boundary"
