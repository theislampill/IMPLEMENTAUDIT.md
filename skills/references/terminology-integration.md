...
- `skills/references/routing.md` owns greenfield/brownfield/mixed routing and
...
| FMEA-lite | Stage 3 risk analysis | `phase-design.md` and `skills/SKILL.md` | Failure mode, cause, effect, detection, countermeasure, owner/source, evidence boundary; no numeric RPN without measured evidence. |
...
Source repo checker `scripts/check-terminology-integration.sh`, source repo
