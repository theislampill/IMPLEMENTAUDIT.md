...
0. Continuity boundary (when resuming): STOP at host-reported-compaction/new-session/
   ...
   Apply references/route-obligations.md: raw continuity only reconciles; request-free route admission requires current NOT_REQUIRED or REQUIRED/SATISFIED; all else refuses.
