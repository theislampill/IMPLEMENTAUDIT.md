...
disposition — is a human-facing projection of the audit object and exact
`WORK_GRAPH.json`. It is derivative, never canonical: on divergence, the run
root, phase specs, and WORK_GRAPH govern, and this projection is corrected to match them.
Record the exact WORK_GRAPH digest.
