...
When several authorised executor routes are valid, select the least-cost sufficiently capable
route after checking context completeness, privacy,
...
resource, and authority boundaries, maintain a work-conserving ready-cell frontier.
Activate worthwhile independent ready cells up to safe host capacity
