...
helper-route: scripts/route_request_policy.py|I|selected-request-validation|scripts/route-transaction.py#_load_route_request_policy|scripts/route-transaction.py#_load_route_request_policy|module|no-route-authority
helper-route: scripts/canonical_hot_projection.py|I|selected-hot-projection|scripts/rotate-canonical-state.py#_load_hot_projection_module|scripts/rotate-canonical-state.py#_load_hot_projection_module|module|no-canonical-publication
helper-route: scripts/operational_query_policy.py|I|selected-read-only-query|scripts/operational-evidence.py#_load_query_policy_module|scripts/operational-evidence.py#_load_query_policy_module|module|no-currentness-authority
helper-route: scripts/closure_automatic_effects.py|I|selected-automatic-effects-check|scripts/check-closure-surface.sh|scripts/check-closure-surface.sh|module|no-effect-authority
