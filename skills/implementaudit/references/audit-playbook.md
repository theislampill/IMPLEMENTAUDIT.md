...
A material row selected for publication, or a material continuation frontier
that fails the existing-carrier sufficiency test, expands through
`issue-ready-work-orders.md` without granting publication authority. This preserves the row as the evidence
