...
with zipfile.ZipFile(asset) as zf:
    ...
    # The composed /improve dominance fold-in plus the S3E W01 conditional
    # decision-state and receiver-currentness controls measure 257,909 bytes.
    # This
    ...
    # leaves 2,091 bytes. The 260,000-byte outer bound is a guard, not a target.
    MAX_ASSET_BYTES = 260_000
    CURRENT_CALIBRATION_ASSET_BYTES = 257_909
