...
with zipfile.ZipFile(asset) as zf:
    ...
    # The composed S3E W01-W04 candidate measures 257,916 bytes. This
    ...
    # leaves 2,084 bytes. The 260,000-byte outer bound is a guard, not a target.
    MAX_ASSET_BYTES = 260_000
    CURRENT_CALIBRATION_ASSET_BYTES = 257_916
