...
# H6-R02: packet tampering fails before a classifier is returned.
...
# H6-R03/R10: stale continuity and pending effects wait for the governor.
...
# H6-R04/R15: every foreign target and graph/writer change is rejected independently.
...
# H6-R05/R06: exactly one evidence ID yields one normalized bounded query.
...
# H6-R11: same context is allowed only for verified interrupted cognition with headroom.
...
# H6-R12: host start/stop observations retain distinct states and establish nothing.
...
# H6-R13: ActiveGraph is optional and cannot override WORK_GRAPH.
